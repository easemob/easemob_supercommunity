 ...
 */
package com.community.easeim.imkit.constants;
...
public interface EaseConstant {
    ...
    String CHANNEL_ID = "voice_channel_id";
    int TYPE_IMAGE_HEAD = 0;
    int TYPE_IMAGE_COVER = 1;
    String VOICE_MEMBER_CHANGE = "voice_member_change";
    String VOICE_MEMBER_ACTION = "voice_member_action";

    String MEDIA_CTRL_ACTION = "media_ctrl_msg";
    String MEDIA_CTRL = "media_ctrl";
    String CHANNEL_CMD = "channel_cmd";
    String CHANNEL_ACTION = "channel_action";
    String CMD_INVITE = "cmd_invite";
    String EXTRA_CHAT_NAME = "extra_chat_name";
    String VOICE_MEMBER_TALKING = "VOICE_MEMBER_TALKING";
    String SWITCH_GROUND = "SWITCH_GROUND";
    String SWITCH_HOME = "SWITCH_HOME";
    String CONTACT_ID = "CONTACT_ID";
    String CONTACT_NAME = "CONTACT_NAME";
    String GROUND_NAME = "ground_name";

    String GROUND_CHANGE = "GROUND_CHANGE";
    String SWITCH_HOME_STROLL = "SWITCH_HOME_STROLL";
