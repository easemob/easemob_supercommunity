package com.community.easeim.imkit.domain;
...
import com.community.easeim.imkit.utils.HanziToPinyin;
...
//        int pos = Integer.getInteger(avatar);
//        return CustomHeadUtil.getInstance().getHeadResId(pos);
//    }
