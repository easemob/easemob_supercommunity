...
import com.community.easeim.imkit.utils.EaseVoiceLengthUtils;
...
public class EaseChatRowVoice extends EaseChatRowFile {
    ...
    protected void onSetUpView() {
        ...
        if (!showSenderType) {
            voiceImageView.setImageResource(R.drawable.icon_waves_gray);
            voiceLengthView.setPadding(0, 0, padding, 0);
        } else {
            voiceImageView.setImageResource(R.drawable.icon_waves_white);
