package com.community.easeim.common.model;
...
public class DemoModel {
    ...
    public boolean isContactOrBlack(String userId) {
        List<String> localUsers = DemoDbHelper.getInstance(context).getUserDao().loadContactUsers();
